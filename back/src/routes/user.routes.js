...
router.put('/users/:id', checkAuth, checkRole({ roles: ['ROLE_ADMIN'] }), userController.updateUser);
router.delete('/users/:id', checkAuth, checkRole({ roles: ['ROLE_ADMIN'] }), userController.deleteUser);
