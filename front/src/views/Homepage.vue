...
<template>
  <div class="bg-white">
    <TheHeader :products="state.products" :categories="state.categories" :cart="state.cart" :cart-open="cartOpen"
      @remove-product-from-cart="removeProductFromCart" @open-cart="toggleCart" />
    <main>
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:grid lg:grid-cols-2 lg:px-8">
              <div class="mx-auto max-w-2xl py-24 lg:max-w-none lg:py-64">
                <div class="lg:pr-16">
                  ...
                  <p class="mt-4 text-xl text-gray-600">Votre partenaire pour tous vos besoins informatiques et
                    bureautiques</p>
                  <div class="mt-6">
        ...
        <div class="py-16 sm:py-24 lg:mx-auto lg:max-w-7xl lg:px-8 lg:py-32">
          ...
          <div class="relative mt-8">
            <div class="relative w-full overflow-x-auto">
              <Shop :products="state.products.slice(-4).reverse()" @add-product-to-cart="addProductToCart"
                class="shop" />
            </div>
          </div>
        </div>
      ...
      <div class="relative overflow-hidden">
        ...
        <section aria-labelledby="sale-heading"
          ...
          <div class="mx-auto max-w-2xl lg:max-w-none">
            <h2 id="sale-heading" class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">Get
      ...
      <Cart :cart="state.cart" :cart-open="cartOpen" @close-cart="toggleCart"
