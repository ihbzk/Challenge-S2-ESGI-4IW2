...
<template>
  <div class="bg-white">
    <TheHeader :cart="state.cart" :cart-open="cartOpen" @remove-product-from-cart="removeProductFromCart" @open-cart="cartOpen = true" />
    <main>
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:grid lg:grid-cols-2 lg:px-8">
              <div class="mx-auto max-w-2xl py-24 lg:max-w-none lg:py-64">
                <div class="lg:pr-16">
                  ...
                  <div class="mt-6">
                    <a href="#" class="inline-block rounded-md border border-transparent bg-indigo-600 px-8 py-3 font-medium text-white hover:bg-indigo-700">Nos produits</a>
                  </div>
                </div>
              </div>
            </div>
