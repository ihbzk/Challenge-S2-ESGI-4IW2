  ...
  <section class="bg-white p-6 rounded-lg shadow-md">
    ...
    <form @submit.prevent="submitReturnRequest" class="space-y-4">
      <div>
        ...
        <select v-model="selectedProducts" id="products" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
