...
// etat réactif pour les produits, le panier et le produit sélectionné
...
// Fonction pour ouvrir ou fermer le panier
const toggleCart = () => {
...
// Charger les données nécessaires lors du montage du composant
onMounted(() => {
        ...
        <div class="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
          <TabGroup as="div" class="flex flex-col-reverse">
            ...
            <div class="aspect-h-1 aspect-w-1 w-full">
              <img :src="state.product.illustration" class="h-full w-full object-cover object-center sm:rounded-lg" />
            </div>
          </TabGroup>
          ...
          <div class="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
            ...
            <form class="mt-6">
              <div v-if="state.product.colors && state.product.colors.length">
                ...
                <fieldset aria-label="Choose a color" class="mt-2">
                  <RadioGroup v-model="selectedColor" class="flex items-center space-x-3">
                    <RadioGroupOption
                      as="template"
                      v-for="color in state.product.colors"
                      :key="color.name"
                      :value="color"
              ...
              <div class="mt-10 flex">
                <button
                  @click.prevent="state.product && addProductToCart(state.product.id!)"
            ...
            <section aria-labelledby="details-heading" class="mt-12 pt-12">
