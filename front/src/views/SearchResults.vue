...
export default {
    ...
    methods: {
        ...
        removeProductFromCart(productId) {
            const productFromCart = this.cart.find(product => product.id === productId);
            if (productFromCart) {
...
<template>
    <div class="bg-white">
        <div>
            <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900">Résultats de recherche pour "{{
                        $route.query.q }}"</h1>
                </div>
                                    ...
                                    <div v-for="product in products" :key="product.id"
                                        ...
                                        <div class="pb-4 pt-10 text-center">
                                            ...
                                            <div class="mt-3 flex flex-col items-center">
                                                ...
                                                <p class="mt-1 text-sm text-gray-500">{{ product.reviewCount }} avis
                                                </p>
                                            </div>
                                            ...
                                            <button @click="addProductToCart(product.id)"
                                                ...
                                                <ShoppingCartIcon
                                                    class="h-6 w-6 flex-shrink-0 text-white group-hover:text-gray-200"
        ...
        <Cart :cart="cart" :cart-open="cartOpen" @close-cart="cartOpen = false"
