  ...
  <div class="bg-gray-100 min-h-screen p-6">
    ...
    <div class="flex justify-between items-center mb-6">
      ...
      <div class="flex space-x-4">
        ...
        <div
          class="flex justify-center items-center px-4 py-2 bg-red-600 text-white rounded-lg shadow-lg cursor-pointer transition duration-300 ease-in-out transform hover:scale-105"
          id="widgetTrash"
        >
          <svg
          ...
          >
            <g>
              <path
                d="M241.348,85.53c-2.184-4.45-5.971-7.782-10.662-9.384L94.056,29.498c-9.686-3.303-20.251,1.884-23.558,11.567l-5.573,16.324l171.753,58.638l5.574-16.323C243.854,95.014,243.533,89.979,241.348,85.53z"
              />
              <path
                d="M148.5,14.472l49.205,16.799l-6.157,18.036l12.069,4.12l8.218-24.07c1.138-3.333-0.642-6.957-3.974-8.095l-61.274-20.92c-1.599-0.547-3.353-0.434-4.871,0.31c-1.518,0.745-2.679,2.064-3.225,3.663l-8.218,24.071l12.07,4.122L148.5,14.472z"
              />
              <path
        ...
        <button
          ...
          class="px-4 py-2 bg-green-600 text-white rounded-lg shadow-lg transition duration-300 ease-in-out transform hover:scale-105"
        >
          Créer un widget
        </button>
      </div>
    ...
    >
      <div class="grid grid-cols-2 gap-8">
        <div>
          ...
          <input
            v-model.number="newWidget.width"
            type="number"
            id="width"
            class="mt-1 border p-2 rounded-lg w-full"
          />
          ...
          <input
            v-model.number="newWidget.height"
            type="number"
            id="height"
            class="mt-1 border p-2 rounded-lg w-full"
          />
          ...
          <label for="dataset" class="block text-sm font-medium text-gray-700 mt-4"
            >Dataset :</label
          >
          <select
            v-model="newWidget.dataset"
            id="dataset"
            class="mt-1 border p-2 rounded-lg w-full"
          >
          ...
          >
            <template #item="{ element, index }">
              <div class="p-2 mb-1 bg-white border border-gray-300 rounded cursor-pointer">
                {{ element }}
              </div>
            </template>
          </draggable>
    ...
    <div class="mx-auto px-4 py-6">
      <div class="flex justify-between items-center">
        <h1 class="text-xl font-semibold text-gray-700">Alerte de gestion des stocks</h1>
      </div>
      <div class="mt-4">
    ...
    <GridStackContainer
      ...
      @deleteWidgets="handleDeleteWidgets"
      class="mt-8"
    >
      <GridStackItem
      ...
      >
        ...
        <BarChart
          ...
          :measuresDatas="widget.measuresDatas"
          :dimensionsDatas="widget.dimensionsDatas"
          :title="widget.title"
        />
        <LineChart
...
const getLowStockProducts = async () => {
  try {
    ...
    const url = `${import.meta.env.VITE_API_URL}/products/low-stock`
    ...
    if (!response.ok) {
      ...
      throw new Error(`Failed to fetch low stock products: ${response.status} - ${errorBody}`)
    }
